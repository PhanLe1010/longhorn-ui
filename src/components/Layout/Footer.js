...
function Footer({ app, host, volume, setting, engineimage, eventlog, backingImage, recurringJob, objectStore, backup, systemBackups, dispatch }) {
...
export default connect(({ app, host, volume, setting, engineimage, eventlog, backingImage, recurringJob, objectStore, backup, systemBackups }) => ({ app, host, volume, setting, engineimage, eventlog, backingImage, recurringJob, objectStore, backup, systemBackups }))(Footer)
